...
public class ForageRoboelectricIntegrationTestRunner extends RobolectricGradleTestRunner {
    ...
    public ForageRoboelectricIntegrationTestRunner(@NonNull Class<?> klass) throws Exception {
        super(klass);
    }

    @NonNull
    public static ForageApplication forageApplication() {
        return (ForageApplication) RuntimeEnvironment.application;
    }
    ...
    public Config getConfig(@NonNull Method method) {
        ...
        return new Config.Implementation(
                ...
                ForageIntegrationTestApplication.class,
