...
/**
 * From https://github.com/artem-zinnatullin/qualitymatters/blob/master/app/src/integrationTests/
 * java/com/artemzin/qualitymatters/integration_tests/api/HttpCodes.java
 */
public class HttpCodes {
    ...
    private static final List<Integer> CLIENT_SIDE_ERROR_CODES = unmodifiableList(asList(
            ...
            405,
            406,
            // 408, OkHttp will do silent retry, so either we need to test that separately or be
            // able to include it in generic tests somehow.
            409,
            410,
            411,
            412,
